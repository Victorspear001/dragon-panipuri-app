...
module.exports = async function (req, res) {
  ...
  try {
    ...
    if (action === 'import' && Array.isArray(data)) {
        for (const c of data) {
            await pool.query('INSERT INTO customers (name, mobile, customer_id, stamps, redeems, lifetime_stamps) VALUES ($1, $2, $3, $4, $5, $6) ON CONFLICT (customer_id) DO NOTHING', [c.name, c.mobile, c.customer_id, c.stamps, c.redeems || 0, c.lifetime_stamps || 0]);
        }
